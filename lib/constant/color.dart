...
class UIColors {
  ...
  static const Color btn = Color(0xFF377dff);
  static const Color yesilmenu = Color(0xFFFAB328);
  static const Color anasite = Color(0xFF377dff);
  static const Color textColor = Color(0xFF677788);
  static const Color morcuk = Color(0xFF676ABB);
  static const Color altmenubg = Color.fromRGBO(0, 0, 0, 0.2);
  static const Color bartrn = Color(0xFFfd7e14);
  static const Color loginbg = Color(0xFF16151E);
  static const Color redmenu = Color(0xFFF03612);
  ...
  static const Color sarimenu = Color(0xFFFFAB328);
  static const Color kahve = Color(0xFFF4b2c20);
  ...
  static const Color placeholder = Color.fromARGB(255, 206, 206, 206);
